import { FiUser, FiPlus, FiSearch, FiUsers, FiFileText, FiX, FiLogOut, FiMenu } from 'react-icons/fi';
...
function Navbar({ currentUser, onOpenSidebar }: NavbarProps) {
        ...
        <>
            <nav className="navbar">
                <div className="nav-content">
                    <button className="icon-btn mobile-sidebar-btn" onClick={onOpenSidebar} title="Communities"><FiMenu size={22} /></button>
                        ...
                        <div className="plus-dropdown" ref={dropdownRef}>
                            ...
                            {open && (
                                <div className="dropdown-menu">
                                    <div className="dropdown-item" onClick={() => { navigate('/write'); setOpen(false); }}>Create Post</div>
